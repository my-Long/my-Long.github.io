...
description: "Why Vue3 switched from Object.defineProperty to Proxy, and what makes Proxy a more capable interception mechanism."
date: 2022-05-10 00:00:00 +0800
categories: [JS, Base]
tags: [vue]
---

Vue3 用 Proxy，Vue2 用 Object.defineProperty，两者的实质性区别是什么？
...
![ecma.jpg](/images/ecma-light.png){: .rounded-10 w='1880' h='1598' .light }
![ecma-dark](/images/ecma-dark.png){: .rounded-10 w='1880' h='1598' .dark }
...
![ecma-proxy.jpg](/images/ecma-proxy-light.png){: .rounded-10 w='1569' h='1194' .light }
![ecma-proxy-dark](/images/ecma-proxy-dark.png){: .rounded-10 w='1569' h='1194' .dark }
...
`defineProperty` 只是执行了对象的一个基本操作 `defineOwnProperty`，它没有办法监听或拦截其他操作。
