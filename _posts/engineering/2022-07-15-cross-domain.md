...
![image.png](/img/engineering/post-content-cross.png)
...
![image.png](/img/engineering/post-content-cross2.png)
...
![image.png](/img/engineering/post-content-cross3.png)
...
![image.png](/img/engineering/post-content-cross4.png)
...
![image.png](/img/engineering/post-content-cross5.png)
...
在很久很久以前...并没有 CORS 方案。
![image.png](/img/engineering/post-content-cross6.png)
...
![image.png](/img/engineering/post-content-cross7.png)
...
![image.png](/img/engineering/post-content-cross8.png)

我们可以找一个中间人做「代理」。注意跨域请求时可以发送的，只不过是在响应的时候被拦住了。

![image.png](/img/engineering/post-content-cross9.png)
...
![image.png](/img/engineering/post-content-cross10.png)

所以一切标准从 「生产环境」出发。

- 生产环境**跨域**
  ![image.png](/img/engineering/post-content-cross11.png)
...
- 生产环境**没有跨域**
  ![image.png](/img/engineering/post-content-cross12.png)
