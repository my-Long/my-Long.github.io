...
「跨域」是个基础又严重的问题，但现代前端开发里很多人并没真正意识到它的存在——Vue 项目脚手架配几个参数就能跑，至于为什么跨域没报错，没几个人深究过。
...
![image.png](/images/post-content-cross-light.png){: .w-75 .shadow .rounded-10 w='884' h='412' .light }
![image.png](/images/post-content-cross-dark.png){: .w-75 .shadow .rounded-10 w='884' h='412' .dark }
_典型的跨域_

## 同源策略和跨域问题

「同源策略」是浏览器的安全机制：同源资源放行，异源资源限制。限制造成的开发问题就是**跨域（异源）问题**。

**源 = 协议（schema）+ 域名（domain）+ 端口（port）**，三个都相同才算同源。
...
![image.png](/images/post-content-cross2-light.png){: .shadow .rounded-10 w='1206' h='1160' .w-75 .light }
![image.png](/images/post-content-cross2-dark.png){: .shadow .rounded-10 w='1206' h='1160' .w-75 .dark }
_浏览器限制异源的请求_
...
![image.png](/images/post-content-cross3-light.png){: .shadow .rounded-10 w='986' h='1234' .w-75 .light }
![image.png](/images/post-content-cross3-dark.png){: .shadow .rounded-10 w='986' h='1234' .w-75 .dark }
_CORS 解决跨域_
...
![image.png](/images/post-content-cross4-light.png){: .shadow .rounded-10 w='1408' h='1196' .w-75 .light }
![image.png](/images/post-content-cross4-dark.png){: .shadow .rounded-10 w='1408' h='1196' .w-75 .dark }
_CORS 简单请求_
...
![image.png](/images/post-content-cross5-light.png){: .shadow .rounded-10 w='1620' h='1186' .w-75 .light }
![image.png](/images/post-content-cross5-dark.png){: .shadow .rounded-10 w='1620' h='1186' .w-75 .dark }
_CORS 预检请求_
...
![image.png](/images/post-content-cross6-light.png){: .shadow .rounded-10 w='1004' h='1214' .w-75 .light }
![image.png](/images/post-content-cross6-dark.png){: .shadow .rounded-10 w='1004' h='1214' .w-75 .dark }
_JSONP 跨域_
...
![image.png](/images/post-content-cross7-light.png){: .shadow .rounded-10 w='1170' h='1238' .w-75 .light }
![image.png](/images/post-content-cross7-dark.png){: .shadow .rounded-10 w='1170' h='1238' .w-75 .dark }
_JSONP 跨域方案_
...
![image.png](/images/post-content-cross8-light.png){: .shadow .rounded-10 w='706' h='894' .w-75 .light }
![image.png](/images/post-content-cross8-dark.png){: .shadow .rounded-10 w='706' h='894' .w-75 .dark }
_普通请求_

我们可以找一个中间人做「代理」。注意跨域请求时可以发送的，只不过是在响应的时候被拦住了。

![image.png](/images/post-content-cross9-light.png){: .shadow .rounded-10 w='1106' h='962' .w-75 .light }
![image.png](/images/post-content-cross9-dark.png){: .shadow .rounded-10 w='1106' h='962' .w-75 .dark }
_代理请求_
...
![image.png](/images/post-content-cross10-light.png){: .shadow .rounded-10 w='1294' h='840' .w-75 .light }
![image.png](/images/post-content-cross10-dark.png){: .shadow .rounded-10 w='1294' h='840' .w-75 .dark }

所以一切标准从 「生产环境」出发。

- 生产环境**跨域**

  ![image.png](/images/post-content-cross11-light.png){: .shadow .rounded-10 w='1170' h='1112' .w-75 .light }
  ![image.png](/images/post-content-cross11-dark.png){: .shadow .rounded-10 w='1170' h='1112' .w-75 .dark }
...
- 生产环境**没有跨域**
  ...
  ![image.png](/images/post-content-cross12-light.png){: .shadow .rounded-10 w='1392' h='1168' .w-75 .light }
  ![image.png](/images/post-content-cross12-dark.png){: .shadow .rounded-10 w='1392' h='1168' .w-75 .dark }
...
url 是异源的（即不同源的 URL），使用 XMLHttpRequest 发起请求会触发跨域限制，除非服务器允许跨域请求。跨域请求会检查 CORS 头，如果服务器没有正确设置 CORS 头，浏览器会阻止请求，并抛出跨域错误。

发生跨域错误是预期的事，因此就这个问题还和后端「友好的沟通」了。最终是让后端将文件所在的服务器配置 CORS 头，允许前端域名访问。

后面仔细研究了这个下载文件的方法，发现毛病太多。

在一个交易列表中，尝试一下下载文件，发现点击了，却毫无反应，下载的弹窗一直不出现，后面发现 Ajax 请求会影响文件下载。
