...
![image.png](/images/post-content-cross.png){: .w-75 .shadow .rounded-10 w='884' h='412' }
_典型的跨域_
...
![image.png](/images/post-content-cross2.png){: .shadow .rounded-10 w='1206' h='1160' .w-75 }
_浏览器限制异源的请求_
...
![image.png](/images/post-content-cross3.png){: .shadow .rounded-10 w='986' h='1234' .w-75 }
_CORS 解决跨域_
...
![image.png](/images/post-content-cross4.png){: .shadow .rounded-10 w='1408' h='1196' .w-75 }
_CORS 简单请求_
...
![image.png](/images/post-content-cross5.png){: .shadow .rounded-10 w='1620' h='1186' .w-75 }
_CORS 预检请求_
...
![image.png](/images/post-content-cross6.png){: .shadow .rounded-10 w='1004' h='1214' .w-75 }
_JSONP 跨域_
...
![image.png](/images/post-content-cross7.png){: .shadow .rounded-10 w='1170' h='1238' .w-75 }
_JSONP 跨域方案_
...
![image.png](/images/post-content-cross8.png){: .shadow .rounded-10 w='706' h='894' .w-75 }
_普通请求_

我们可以找一个中间人做「代理」。注意跨域请求时可以发送的，只不过是在响应的时候被拦住了。

![image.png](/images/post-content-cross9.png){: .shadow .rounded-10 w='1106' h='962' .w-75 }
_代理请求_
...
![image.png](/images/post-content-cross10.png){: .shadow .rounded-10 w='1294' h='840' .w-75 }

所以一切标准从 「生产环境」出发。

- 生产环境**跨域**

  ![image.png](/images/post-content-cross11.png){: .shadow .rounded-10 w='1170' h='1112' .w-75 }
...
- 生产环境**没有跨域**
  ...
  ![image.png](/images/post-content-cross12.png){: .shadow .rounded-10 w='1392' h='1168' .w-75 }
